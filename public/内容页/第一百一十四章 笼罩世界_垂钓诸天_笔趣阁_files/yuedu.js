...
function showbook(){
	...
	if(books.length){
		...
		for(var i=books.length-1;i>-1;i--){//for(var i=0 ;i<books.length;i++){
			...
			bookhtml+='<li>';
			bookhtml+='<p class="p2"><span>'+(i+1)+'</span><a href="/wapbook/'+books[i][0]+'.html">'+books[i][2]+'</a></p>';
			bookhtml+='<p class="p3">看过：<a href="/wapbook/'+books[i][0]+'_'+books[i][1]+'.html" >'+books[i][3]+'</a></p>';
